    ...
    <Card className="grid gap-4 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="ml-auto flex flex-none flex-col items-end gap-1">
          ...
          {screeningStatus === 'SETUP_REQUIRED' ? <><Badge tone="warning">Setup required</Badge><Link className="text-xs font-semibold text-harbor no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-glacier" to={`/jobs/${job.id}/screening-rubric`}>Configure rubric</Link></> : null}
