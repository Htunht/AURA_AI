            ...
            return (
              <tr key={application.id} className="transition-colors hover:bg-glacier/[0.07]">
                ...
                <td className="px-4 py-4 align-top">
                  ...
                  {screeningStatus === 'SETUP_REQUIRED' ? <div><Badge tone="warning">Setup required</Badge><Link className="mt-1.5 block text-xs font-semibold text-harbor no-underline hover:text-depth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-glacier" to={`/jobs/${job.id}/screening-rubric`}>Configure rubric</Link></div> : null}
