...
const iconByType = {
  ...
  FINAL_REVIEW_STARTED: ScanSearch,
  ...
  OUTCOME_DRAFT_CREATED: FileCheck2,
  OUTCOME_COMMUNICATION_PREPARED: MailCheck,
  HOLD_FOLLOW_UP_SCHEDULED: CalendarClock,
  HOLD_READY_FOR_REVIEW: CheckCircle2,
  DECISION_REVIEW_REOPENED: UserCheck,
