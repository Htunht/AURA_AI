...
export function SchedulingInvitationCard({ model }: { model: SchedulingAutomationViewModel }) {
      ...
      <div className="border-l-4 border-l-marine p-5 md:p-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mb-0 mt-1 text-sm text-aura-text-secondary">{job.title}</p>
          </div>
          <Badge tone="accent">Candidate action</Badge>
        </div>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_0.92fr]">
          <div>
            ...
            <p className="mb-0 mt-1 text-xs leading-5 text-aura-text-muted">
              Scheduling link ready to share. The candidate chooses the final interview time.
            </p>
            <div className="mt-4">
