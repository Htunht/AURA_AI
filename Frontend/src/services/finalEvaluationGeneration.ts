...
import { fingerprintInterviewAnalysis, fingerprintInterviewTranscript } from '../utils/finalEvaluationSourceFingerprint'
...
export function generateFinalEvaluation(input: { candidateId: string; applicationId: string; jobId: string; interviewId: string; analysisId: string; rubric: PublishedInterviewScoringRubric; questions: InterviewQuestion[]; answerSegments: DeidentifiedAnswerSegment[]; evidence: InterviewEvidence[]; analysis: InterviewAnalysis; transcript?: InterviewTranscript; sessionProgress: InterviewSessionQuestionProgress[]; existingEvaluations: FinalEvaluation[]; generatedAt: string }): FinalEvaluationGenerationResult {
