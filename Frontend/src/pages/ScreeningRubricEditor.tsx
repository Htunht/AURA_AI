...
export default function ScreeningRubricEditor() {
  ...
  return <PageContainer eyebrow="AI screening setup" title={`${job.title} rubric`} description="Define the evidence AURA evaluates. Published rubrics power automatic screening; recruiters retain every hiring decision." actions={<Link className={backClass} to={`/jobs/${job.id}`}><ArrowLeft size={16} />Job details</Link>}>
