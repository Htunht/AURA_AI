...
const createClass = 'inline-flex h-9 items-center justify-center gap-2 rounded-aura-sm border border-harbor bg-harbor px-3.5 text-sm font-semibold text-frost no-underline hover:bg-depth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-glacier'
